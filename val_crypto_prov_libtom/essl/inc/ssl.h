...
/* *********************************************************************** */
//TODO vpy ECDSA: add ECC key
typedef struct ssl_certificate
{
//   /* Public Key of the certificate if RSA*/
//   cw_rsaPubKey_t        cwt_caPubKey;
//
//   /* Public Key of the certificate if RSA*/
//   ecc_key        		 caECCPubKey;
//
//   /* Indicate the type of key present in certificate*/
//   e_sslKeyType_t		 keyType;
...
typedef struct ssl_peerGlobalSettings
{
   ...
   cw_rsaPrivKey_t*         pcwt_rsaMyPrivKey;
...
typedef struct ssl_securityParameters
{
   ...
   union {
    cw_rc4Ctx_t        	cwt_cliRc4Ctx;
    cw_aesCtx_t         cwt_cliAesCtx;
    cw_3desCtx          cwt_cli3DesCtx;
   } u_cliKey;
   union {
    cw_rc4Ctx_t         cwt_srvRc4Ctx;
    cw_aesCtx_t         cwt_srvAesCtx;
    cw_3desCtx          cwt_srv3DesCtx;
   } u_srvKey;
   ...
   uint8_t              ac_cliSecret[CW_MAX_HASHSIZE];
   uint8_t              ac_srvSecret[CW_MAX_HASHSIZE];
}s_sslSecParams_t;
