...
/*!
 ...
 \param     pcwt_rsaPubKey       Pointer to an initialised public key struct (RSA) where the public key will be written to if RSA cert
 \param     p_eccKey	         Pointer to an initialised public key struct (ECDSA) where the public key will be written to if ECDSA cert
...
/*!
 ...
 key of the end-point certificate shall be saved.
  ...
  \param    p_eccKey	   Pointer to a public key structure where the public
 key of the end-point certificate shall be saved.
