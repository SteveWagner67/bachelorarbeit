...
#define SSL_OID_SHA256_WITH_ECDSA_ENC	 (SSL_OID_PKCS + 12) //vpy
#define SSL_OID_EC_PUBLIC_KEY			 (SSL_OID_PKCS + 13) //vpy
...
#define SSL_OID_EC_CURVES				 1000	//vpy
#define SSL_OID_EC_SECP160R1			 (SSL_OID_EC_CURVES+1)
#define SSL_OID_EC_SECP224R1			 (SSL_OID_EC_CURVES+2)
#define SSL_OID_EC_SECP384R1			 (SSL_OID_EC_CURVES+3)
#define SSL_OID_EC_SECP521R1		 	 (SSL_OID_EC_CURVES+4)
#define SSL_OID_EC_BRAINPOOLP256R1		 (SSL_OID_EC_CURVES+5)
#define SSL_OID_EC_BRAINPOOLP384R1		 (SSL_OID_EC_CURVES+6)
#define SSL_OID_EC_BRAINPOOLP512R1		 (SSL_OID_EC_CURVES+7)
