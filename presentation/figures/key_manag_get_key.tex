...
\path (int.east)+(4,0) node (app) [rect] {Application};
\path (int.east)+(1.5,0) node (res) [txtblk] {\scriptsize{Get Key with ID x}};

\path (int.east)+(1.5,-1) node (res) [txtblk] {\scriptsize{Key}};


\path [draw, <-] (int.east) -- (app.west);
\path [draw, ->] (int.south) -- (0,-1) -| (app.south);
