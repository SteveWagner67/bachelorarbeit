...
\path (int.east)+(1.25, -0.25) node (text22) [txtblk] {\scriptsize{ID x:}};
...
\path (app.south)+(-1.25,-0.5) node (text4) [txtblk] {\footnotesize{Delete
Key}};
...
\path (text6.south)+(0,-0.25) node (text21) [txtblk] {\footnotesize{}};
