...
\begin{pgfonlayer}{background}
	...
	\path (dom.west |- dom.north)+(-0.25,0.25) node (a) {};
  	\path (secKey1.south -|  secKey1.east)+(0.75,-0.75) node (b) {};      
...
\path (secKey1.south)+(-1,-0.7) node (alice) [txtblk]
{\small{Peer A}};
...
\begin{pgfonlayer}{background}
	...
	\path (keyPrivB.west |- keyPrivB.north)+(-0.5,1.3) node (e) {};
  	\path (secKey2.south -|  secKey2.east)+(0.75,-0.75) node (f) {};      
...
\path (secKey2.south)+(-1,-0.7) node (bob) [txtblk] {\small{Peer B}};
...
\path (secKey2.south -|  secKey2.east)+(-2.75,-0.75) node (d) {};      
          
% Combine the twos nodes above for creating the rectangle      
\path[fill=red!60,rounded corners, draw=black!50, dashed]
(c) rectangle (d);  
    
\path (secKey1.south)+(3.6,-0.7) node (alice) [txtblk]
{\small{Insecure network}};


\path [draw, ->] (dom.east) edge[bend left=20] (calc1.east);
...
\path [draw, ->] (keyPrivB.east) edge[bend left=20] (calc4.east);
