...
\path (finish.east)+(0.95,0) node (digest) [txtblk, text
width=7em] {\scriptsize{Signature}};

\path (hash4.north)+(4.65,1) node (app) [txtblk, text
...
\begin{pgfonlayer}{background}
	...
	\path (hashn1.west |- app.north)+(-1,0.25) node (a) {};
  	\path (finish.south -|  digest.east)+(0.35,-0.25) node (b) {};      
...
\path (finish2.east)+(0.95,0) node (digest2) [txtblk, text
width=7em] {\scriptsize{Signature}};

\path (update21.south)+(4.65,-1) node (int) [txtblk, text
width=3em] {Interface};
...
\begin{pgfonlayer}{background}
  	...
  	%create  the lines of the rectangle  with an offset (x,y)         
	\path (hashn1.west |- hash21.north)+(-1,0.25) node (c) {};
  	\path (int.south -|  digest2.east)+(0.35,-0.25) node (d) {};      
...
\path [draw, <-] (digest.south)+(0,-0.5) -- (11.9,-2.8);
